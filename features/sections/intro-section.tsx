  ...
  return (
    <section className="section-padding bg-surface text-ink" aria-label="Intro">
      <div className="layout-grid">
        ...
        <div className="col-span-6 col-start-5 mt-40 lg:col-span-2 lg:col-start-5 lg:mt-60">
          <p className="type-eyebrow mb-10">{t("missionEyebrow")}</p>
          <p className="type-body">{t("missionBody")}</p>
        </div>

        <div className="col-span-6 col-start-5 mt-40 lg:col-span-2 lg:col-start-8 lg:mt-60">
