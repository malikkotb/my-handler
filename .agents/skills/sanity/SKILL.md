...
- For typed object factories (`createMediaField`, `createLinkField`, `createHeroField`), keep internal type guards and compose them with caller-provided `validation` (do not override caller validation).
