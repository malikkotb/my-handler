...
7. In final response, include a short "Docs updated" list with paths.
...
- `features/view-transition/**` or `features/use-content-ready.ts` (transition gating) -> `docs/features/view-transitions.md`; gating changes often affect `docs/features/animated-content.md` too
