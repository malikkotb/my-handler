...
export const sanityConfig = {
  ...
  /**
   * Host endpoints the Studio calls. `draftMode*` are joined to `appUrl`; `seoScreenshot` is fetched
   * same-origin. A non-Next host implements equivalents and updates these paths.
   */
  endpoints: {
