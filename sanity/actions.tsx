...
/**
 * Create an action that opens the live site for this document (draft mode off).
 */
...
/**
 * Create an action that opens the site in draft/preview mode for this document.
 */
...
/**
 * Create an action that opens the Presentation tool for this document.
 */
...
/**
 * Create an action that opens the Structure tool for this document (from Presentation).
 */
